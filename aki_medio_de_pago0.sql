...
CREATE TABLE `medio_de_pago` (
  ...
  `descripcion_abreviada` varchar(30) NOT NULL,
  `categoria_de_pago` varchar(8) NOT NULL,
  `Desc_metodo_de_pago` varchar(30) DEFAULT NULL,
...
-- Dump completed on 2024-07-11  0:28:55
